...
-   Erfolgreicher Abschluss [**mindestens**]{.underline} **eines Moduls der Kommunikationswissenschaft** ([Lehrangebot des Lehrstuhls & der Juniorprofessur](https://www.kowi.rw.fau.de/lehre/))
...
df %>%
  ...
  tab_footnote(
    footnote = "⚠️ Alle Kurse auf Italienisch!",
    placement = "right", 
    locations = cells_column_labels(
      columns = 4)
  ) %>% 
...
df %>% 
  ...
  tab_footnote(
    footnote = "⚠️ Alle Kurse auf Spanisch!",
    placement = "right", 
    locations = cells_column_labels(
      columns = 4)
  ) %>% 
...
::: {style="font-size: smaller;"}
1.  Bewerbung für das akademische Jahr 2025/2026 (Winter- und Sommersemester) über das [**Online-Bewerbungsformular (ab 15.11. verfügbar)**](https://ib.wiso.fau.de/outgo/allgemeines/bewerbung/bewerbungsformular-outgoing/) des [Büros für Internationale Beziehungen](https://ib.wiso.fau.de/outgo/bewerbung/). Der Bewerbungsschluss ist **Dienstag, 5. Dezember 2024, 12.00 Uhr**
