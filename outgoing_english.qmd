...
source(here:("C://Users//leuner//erasmus-program//erasmus-program//R//data_creation_en.R")
source(here("R/data-data_creation.r"))
```

```{r import-db}
#| echo: false
#| message: false
df_en_2 <- qread(here("data/universities-geo_locations_en_e2.qs"))
```
...
-   Please note the general [eligibility requirements](https://ib.wiso.fau.de/en/outgo/application/) for the exchange programme on the website of the [International Relations Office](https://ib.wiso.fau.de/en/).
-   The programmes of the chair of Communication Science are **exclusively social science exchange programmes!**\
:::
...
-   Successful completion of **at least one module in Communication Science**([Chair](https://www.commsci.rw.fau.eu/teaching/) oder [Assistant Professorship](https://www.kommunikationswissenschaft.rw.fau.de/lehre/)). Applies **to both Bachelor's and Master's students**. **For *Bachelor* students, we particularly recommend attending one of our lectures**:
...
-   Successful completion of at least one communication studies course at the specific institution (faculty, department, etc.) of the respective partner university with which the cooperation agreement exists (see list of cooperating universities).
-   In addition, the overall focus of the courses taken should be on communication science or social science courses from the programme of the specific partner institution. Taking courses at other faculties / institutions / departments of the partner university is only possible in occasional cases or in some cases not at all!

### After the stay:

-   After your stay abroad, there are still a few steps to take in order to have your credits entered and converted. You can find helpful information on this in the section [Accrediation of academic achievements]
...
🔗 [Information on Accrediation and grade transfer](https://ib.wiso.fau.de/en/outgo/nach-dem-aufenthalt/accreditation-grade-transfer/)
...
Please submit requests for Learning Agreements via [E-Mail](mailto:christoph.adrian@fau.de?subject=Learning%20Agreement), providing the following information in full:
...
A study abroad is particularly recommended for students who choose Communication Studies as their specialization. Although it is generally possible to take the basic courses abroad, they must correspond to the courses offered by the department and have an introductory character. Since the course offerings abroad are often limited, credit transfer for basic courses cannot be guaranteed.
...
In time preparations for studying abroad is a part of the exchange process that should not be underestimated. FAU offers many useful options, e.g.,
